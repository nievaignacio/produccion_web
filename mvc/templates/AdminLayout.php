                    ...
                    <div class="col-auto col-md-3 col-xl-2 px-sm-2 px-0 bg-dark position-fixed">
                        <div class="d-flex flex-column align-items-center align-items-sm-start px-3 pt-2 text-white min-vh-100">
                            <a href="<?= BASE_URL?>" class="d-flex align-items-center pb-3 mb-md-0 me-md-auto text-white text-decoration-none">
                                <span class="fs-5 d-none d-sm-inline">Mi tienda</h1>
                            </a>
                            <ul class="nav nav-pills flex-column mb-sm-auto mb-0 align-items-center align-items-sm-start" id="menu">
                                ...
                                <li class="nav-item">
                                    <a href="<?= BASE_URL?>/admin/productos" class="nav-link align-middle px-0">
                            ...
                            <li class="w-100">
                                <a href="#" class="nav-link px-0"> <span class="d-none d-sm-inline">Listar</span> </a>
                            </li>
                            <li>
                                <a href="#" class="nav-link px-0"> <span class="d-none d-sm-inline">Agregar</span> </a>
                            </li>
                        </ul> -->
                                </li>
                                <li class="nav-item">
                                    <a href="<?= BASE_URL?>/admin/usuarios" class="nav-link align-middle px-0">
                            ...
                            <div class="dropdown pb-4">
                                <a href="#" class="d-flex align-items-center text-white text-decoration-none dropdown-toggle" id="dropdownUser1" data-bs-toggle="dropdown" aria-expanded="false">
                                    ...
                                    <span class="d-none d-sm-inline mx-1"><?= $usuario->nombre;?></span>
                                </a>
                                <ul class="dropdown-menu dropdown-menu-dark text-small shadow" aria-labelledby="dropdownUser1">
                                    ...
                                    <li><a class="dropdown-item" href="<?= BASE_URL?>/usuarios/logout">Sign out</a></li>
                                </ul>
                            </div>
                        </div>
                    </div>
